...
$dati = array();
// cerco gli utenti unici;

$users = array();
while ($row = mysqli_fetch_assoc($risultato)) {
    $dati[]= $row;
    // funzione nel file activeUsers.
    addActiveUser($users,$row);
...
echo "<div id=\"active-users\">";
    echo "<h2> UTENTI ATTIVI </h2>";
        echo "<ul>";  
// inersico i dati della query che ho fatto al database. 
foreach ($users as $row) {
$link = "https://sia4fun.altervista.org/userPosts.php?utente=".$row["id"]."";

echo "<li class=\"user\">";
echo      "<a href=\"$link \">".$row["nome"]."</a>";
echo "</li>";
